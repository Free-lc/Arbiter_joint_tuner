...
class Benchmark:
    def __init__(
        ...
        self.cost_estimation_duration = self.db_connector.cost_estimation_duration  # what_if计算cost的时间
        self.index_simulation_duration = self.db_connector.index_simulation_duration    # 建立虚拟索引的时间
    ...
    def _benchmark(self):
        ...
        with open(self.totalcost, "a") as f:
            if 'budget_MB' in self.config['parameters']:
                f.write(f"\n{self.config['parameters']['budget_MB']} : Overall Costs: {overall_costs}")
            else:
    ...
    def _set_filenames(self):
        ...
        self.totalcost = f"benchmark_results/totalcost_{identifier}_queries.csv"
